...
def animate(i):
    r = np.load('evolucio7/triangleR_r-'+str(50*i)+'.npy')
...
r0 = np.load('evolucio7/triangleR_r-0.npy')
...
# red_index = np.where(np.sqrt(r0[:,0]**2+r0[:,1]**2)<3)
# blu_index = np.where((np.sqrt(r0[:,0]**2+r0[:,1]**2)>3)*(np.sqrt(r0[:,0]**2+r0[:,1]**2)<6))
# gre_index = np.where((np.sqrt(r0[:,0]**2+r0[:,1]**2)>6)*(np.sqrt(r0[:,0]**2+r0[:,1]**2)<9))
# yel_index = np.where((np.sqrt(r0[:,0]**2+r0[:,1]**2)>9)*(np.sqrt(r0[:,0]**2+r0[:,1]**2)<400))
...
# animate(0)
# plt.show()
ani.save('video_triangle_random2.mp4', writer='ffmpeg', fps=20)
