...
s=0
np.save((r'evolucio8\triangleT_r-'+str(s)), r)
np.save((r'evolucio8\triangleT_v-'+str(s)), v)
for i in range(200):
    s+=50
...
np.save((r'last_state8\triangleT_r-'+str(s)), r)
np.save((r'last_state8\triangleT_v-'+str(s)), v)
np.save((r'last_state8\triangleT_F-'+str(s)), F)
