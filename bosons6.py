...
s=0
np.save((r'evolucio6\triangleT_r-'+str(s)), r)
np.save((r'evolucio6\triangleT_v-'+str(s)), v)
for i in range(200):
    s+=50
...
np.save((r'last_state6\triangleT_r-'+str(s)), r)
np.save((r'last_state6\triangleT_v-'+str(s)), v)
np.save((r'last_state6\triangleT_F-'+str(s)), F)
