...
s=0
np.save((r'evolucio5\triangleT_r-'+str(s)), r)
np.save((r'evolucio5\triangleT_v-'+str(s)), v)
for i in range(200):
    s+=50
    nf.verlet_steps(r=r, v=v, f=F, t=t, steps=25, k=k, g=g, dt=dt)
    np.save((r'evolucio5\triangleT_r-'+str(s)), r)
    np.save((r'evolucio5\triangleT_v-'+str(s)), v)
    print(t, datetime.datetime.now())
np.save((r'last_state5\triangleT_r-'+str(s)), r)
np.save((r'last_state5\triangleT_v-'+str(s)), v)
np.save((r'last_state5\triangleT_F-'+str(s)), F)
