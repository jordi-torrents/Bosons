...
plt.plot(t, overlap_fun(r'evolucio10/triangleT_025max_r-'), label='th=0.25*max(r)')
plt.plot(t, overlap_fun(r'evolucio10/triangleT_05max_r-'), label='th=0.5*max(r)')
plt.plot(t, overlap_fun(r'evolucio9/triangleT_r-'), label='No th')
plt.legend(ncol=3)
