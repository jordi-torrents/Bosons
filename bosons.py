...
# initial_square()
initial_triangle()
r = np.load(r'evolucio4\triangleR_r-0.npy')
# initial_circle()
...
g=1.0
E_inter, E_tramp, E_kin = nf.mesure_th(r=r, v=v, n=N, k=k, g=g, th=th)
...
# s=0
# np.save((r'evolucio8\triangleR_r-'+str(s)), r)
# np.save((r'evolucio8\triangleR_v-'+str(s)), v)
# for i in range(200):
#     s+=50
...
# np.save((r'last_state8\triangleR_r-'+str(s)), r)
# np.save((r'last_state8\triangleR_v-'+str(s)), v)
# np.save((r'last_state8\triangleR_F-'+str(s)), F)
